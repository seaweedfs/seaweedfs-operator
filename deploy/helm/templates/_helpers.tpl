...
- name: wait-for-webhook
  ...
  command: ['sh', '-c', 'until wget -q --spider --timeout=5 --no-check-certificate https://{{ include "seaweedfs-operator.fullname" . }}-webhook.{{ .Release.Namespace }}.svc:443{{ .webhookPath }}; do echo waiting for webhook; sleep 1; done;']
{{- end -}}
